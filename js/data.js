...
(function(){
  ...
  var DEFAULT_FAMILY=[
    {name:'Mama',nickname:'',fill:nextColor(),gender:'f',accent:'',photo:null,img:null,group:'Parents',custom:false},
    {name:'Dada',nickname:'',fill:nextColor(),gender:'m',accent:'',photo:null,img:null,group:'Parents',custom:false},
    {name:'Baby',nickname:'',fill:nextColor(),gender:'f',accent:'',photo:null,img:null,group:'Parents',custom:false},
    {name:'Grandma',nickname:'',fill:nextColor(),gender:'f',accent:'',photo:null,img:null,group:'Grandparents',custom:false},
    {name:'Grandpa',nickname:'',fill:nextColor(),gender:'m',accent:'',photo:null,img:null,group:'Grandparents',custom:false},
    {name:'Abuelita',nickname:'',fill:nextColor(),gender:'f',accent:'mx',photo:null,img:null,group:'Grandparents',custom:false},
    {name:'Abuelito',nickname:'',fill:nextColor(),gender:'m',accent:'mx',photo:null,img:null,group:'Grandparents',custom:false},
    {name:'Sister',nickname:'',fill:nextColor(),gender:'f',accent:'',photo:null,img:null,group:'Siblings',custom:false},
    {name:'Brother',nickname:'',fill:nextColor(),gender:'m',accent:'',photo:null,img:null,group:'Siblings',custom:false},
    {name:'Auntie',nickname:'',fill:nextColor(),gender:'f',accent:'',photo:null,img:null,group:'Aunts & Uncles',custom:false},
    {name:'Uncle',nickname:'',fill:nextColor(),gender:'m',accent:'',photo:null,img:null,group:'Aunts & Uncles',custom:false},
    {name:'Tia',nickname:'',fill:nextColor(),gender:'f',accent:'mx',photo:null,img:null,group:'Aunts & Uncles',custom:false},
    {name:'Tio',nickname:'',fill:nextColor(),gender:'m',accent:'mx',photo:null,img:null,group:'Aunts & Uncles',custom:false},
    {name:'Cousin',nickname:'',fill:nextColor(),gender:'f',accent:'',photo:null,img:null,group:'Cousins',custom:false},
  ];
